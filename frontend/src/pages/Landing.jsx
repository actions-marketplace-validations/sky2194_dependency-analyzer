...
.lp-nav-links{display:flex;gap:2px;margin-left:32px;flex:1}.lp-nav-link{padding:6px 14px;border-radius:7px;font-size:13.5px;color:var(--text-2);text-decoration:none;transition:all .15s;background:none;border:0;cursor:pointer}.lp-nav-link:hover{color:var(--text);background:var(--bg-elevated)}.lp-nav-cta{display:flex;gap:10px;align-items:center}
